"""
Evaluate whether the US ETF signal survives execution.

    python -m scripts.evaluation.us_backtest
    python -m scripts.evaluation.us_backtest --min-adv 50e6 --top 0.1
