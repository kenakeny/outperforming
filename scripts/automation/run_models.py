"""Launch the five-model experiment sweep in parallel and summarize.
...
experiments/results/model_<name>.json.
    ...
    python -m scripts.automation.run_models            # run everything
    python -m scripts.automation.run_models lstm xgb   # run a subset
    python -m scripts.automation.run_models --summary  # print leaderboard
"""
import json
import pathlib
import subprocess
