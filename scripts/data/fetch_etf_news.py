"""
Pull Polygon.io news for every ETF in the price panel.
...
Usage:
    python -m scripts.data.fetch_etf_news                 # all tickers
    python -m scripts.data.fetch_etf_news --limit 10      # smoke test
    python -m scripts.data.fetch_etf_news --tickers SPY,QQQ,IWM
    python -m scripts.data.fetch_etf_news --rpm 100
