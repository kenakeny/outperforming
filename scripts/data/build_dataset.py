"""
scripts.data.build_dataset — one self-contained dataset builder.
...
USAGE
  ...
  python -m scripts.data.build_dataset                 # default horizon
  python -m scripts.data.build_dataset --horizon 5     # 1-week label
  python -m scripts.data.build_dataset --period 5y     # shorter history
