"""
backtest_vs_spy.py -- point it at a saved model, get a SPY comparison.

    python backtest_vs_spy.py models/catboost_sr.cbm
    python backtest_vs_spy.py models/xgboost_sr.ubj --year 2025 --top 0.1
    python backtest_vs_spy.py models/logreg_sr.joblib --horizon 5 --min-adv 50e6 --plot
