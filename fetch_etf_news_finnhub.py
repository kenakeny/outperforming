"""
fetch_etf_news_finnhub.py -- pull Finnhub news for every ETF in the price panel.
...
Usage:
    python fetch_etf_news_finnhub.py                 # all tickers, resume-aware
    python fetch_etf_news_finnhub.py --limit 10      # smoke test
    python fetch_etf_news_finnhub.py --tickers SPY,QQQ,IWM
    python fetch_etf_news_finnhub.py --rpm 30        # throttle harder
    python fetch_etf_news_finnhub.py --dry-run       # print plan, no API calls
...
from fetch_etf_news import etf_date_ranges, load_done, RateLimiter, resolve_root
