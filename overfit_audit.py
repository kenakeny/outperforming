"""
overfit_audit.py -- how much of the measured edge survives the number of things I tried?
...
constraint. Unadjusted significance is therefore reported FIRST.
    ...
    python overfit_audit.py              # reuses cached grid
    python overfit_audit.py --rebuild    # re-runs portfolio construction
"""
import argparse
import itertools
import json
